...
const DarkModeButton: React.FC = () => {
  return (
    <button className="border-gray-600 hover:border-gray-400 focus:border-gray-400 inline-flex items-center justify-center p-1 h-14 border-2 rounded-full focus:outline-none overflow-hidden transition w-14">
